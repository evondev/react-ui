...
function App() {
  ...
  const toggleShowAccount = (value: boolean = !showAccount) => {
  ...
  return (
    <div className="flex justify-center h-screen items-center">
      ...
      >
        <div className="bg-white w-[230px] shadow py-5 px-4 rounded-2xl translate-y-5">
          <div className="flex flex-col items-start gap-5 pb-8 border-b border-gray-200 mb-8">
            <a
              href="#"
              className="text-gray-700 font-medium inline-block hover:text-blue-500"
            >
              Account
            </a>
            <a
          ...
          <div className="flex items-center gap-3 cursor-pointer hover:opacity-80">
            ...
            <span className="text-gray-700 font-normal">Sign out</span>
          </div>
        </div>
      </Dropdown>
    </div>
